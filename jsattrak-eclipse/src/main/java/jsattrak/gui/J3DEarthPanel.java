...
public class J3DEarthPanel extends javax.swing.JPanel implements J3DEarthComponent
{
    ...
    private WorldWindowGLCanvas wwd; //WorldWindowGLCanvas wwd; or WorldWindowGLJPanel if an internal window

    JDialog parent; // parent dialog
//    private boolean internalWindow;
//    JInternalFrame parentInternal; // parent dialog
//    JDialog parentExternal; // parent dialog
    ...
    public J3DEarthPanel(JDialog parent, Hashtable<String, AbstractSatellite> satHash, Hashtable<String, GroundStation> gsHash, double currentMJD, JSatTrak app)
    {
        ...
        {
            if (layer instanceof MercatorTiledImageLayer)
            {
                ((MercatorTiledImageLayer) layer).setShowImageTileOutlines(false);
            }
            ...
            if (layer instanceof StarsLayer)
            {
                ...
                //damico starsLayer.setRadius(starsLayer.getRadius()*10.0);
            }
...
//Get the default graphics configuration from the graphics environment
    ...
    public void setModelViewNearClip(double modelViewNearClip)
    {
        ...
        {
        	BasicView bView = (BasicView) wwd.getView();
        	bView.setFarClipDistance(modelViewNearClip);
        	wwd.setView(bView);
            //damico wwd.getView().setNearClipDistance(modelViewNearClip);
        }
    }
    ...
    public void setModelViewFarClip(double modelViewFarClip)
    {
        ...
        if(this.isModelViewMode())
        {
        	...
        	BasicView bView = (BasicView) wwd.getView();
        	bView.setFarClipDistance(modelViewFarClip);
        	wwd.setView(bView);
            //damico wwd.getView().setFarClipDistance(modelViewFarClip);
        }
    }
    ...
    private void setupView()
    {
        ...
        { // Earth View mode
            ...
            BasicView bView = (BasicView) wwd.getView();
        	bView.setNearClipDistance(this.nearClippingPlaneDistOrbit);
        	bView.setFarClipDistance(this.farClippingPlaneDistOrbit);
        	wwd.setView(bView);
            
            //damico wwd.getView().setNearClipDistance(this.nearClippingPlaneDistOrbit);
            //damico wwd.getView().setFarClipDistance(this.farClippingPlaneDistOrbit);
...
//            {
//            	bmv = new BasicModelView2(centerPosition, sat);
//            	
//               //bmv = new BasicModelView2(((BasicOrbitView)wwd.getView()).getOrbitViewModel(), sat);
...
//            
//            BasicView bView = (BasicView) wwd.getView();
//        	bView.setNearClipDistance(modelViewNearClip);
//        	bView.setFarClipDistance(modelViewFarClip);
//        	wwd.setView(bView);
//            
//        	//damico wwd.getView().setNearClipDistance(modelViewNearClip);
...
//            }
    ...
    public void setOrbitFarClipDistance(double clipDist)
    {
        ...
        {
        	BasicView bView = (BasicView) wwd.getView();
        	bView.setFarClipDistance(nearClippingPlaneDistOrbit);
        	wwd.setView(bView);
            //damico wwd.getView().setFarClipDistance(farClippingPlaneDistOrbit);
        }
    }
    ...
    public void setOrbitNearClipDistance(double clipDist)
    {
        ...
        {
        	BasicView bView = (BasicView) wwd.getView();
        	bView.setNearClipDistance(nearClippingPlaneDistOrbit);
        	wwd.setView(bView);
           //damico wwd.getView().setNearClipDistance(nearClippingPlaneDistOrbit);
        }
    }
