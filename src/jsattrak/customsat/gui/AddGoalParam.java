 ...
 * @author  sgano
 */
public class AddGoalParam extends javax.swing.JPanel
{
    ...
    public AddGoalParam(CustomTreeTableNode solverNode, SolverPanel solvePan)
    {
        ...
        DefaultMutableTreeNode rootNode = new DefaultMutableTreeNode("Goals");
        ...
        for(int i=0;i<solverNode.getChildCount();i++)
        {
            ...
            Vector<GoalParameter> varVec = node.getGoalParamVector();
            ...
            for(GoalParameter inVar : varVec)
            {
    ...
    {//GEN-HEADEREND:event_addVarButtonActionPerformed
        ...
        for (int i = 0; i < treePaths.length; i++)
        {
            ...
            if(currentObj instanceof GoalParameter)
            {
                GoalParameter iv = (GoalParameter) currentObj;
                
                // add to SolverPanel
                solvePan.addGoalParameter(iv);
