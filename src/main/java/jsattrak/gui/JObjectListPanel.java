...
public class JObjectListPanel extends javax.swing.JPanel
{
    ...
    public JObjectListPanel( Hashtable<String,AbstractSatellite> satHashIn, Hashtable<String,GroundStation> gsHash, JSatTrak app )
    {
        ...
        objectTree.setCellRenderer((TreeCellRenderer) new IconTreeNodeRenderer());
